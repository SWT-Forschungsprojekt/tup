...
class predictorUtils {
  public:
    ...
    static void set_trip_update(std::string tripID, std::string_view stopID, std::string vehicleID, std::string routeID, int64_t newArivalTime, int32_t uncertainty, transit_realtime::FeedMessage& outputFeed);
};
